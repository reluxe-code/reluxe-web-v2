...
export const servicesData = [
  {
    title: 'Botox, Dysport, Daxxify & Jeuveau',
    items: [
      { name: 'Jeuveau', price: '$12/unit + ($40 off)' },
  ...
  },
  {
    ...
    items: [
      { name: '60-min Choice Massage', price: '$125' },
      { name: '90-min Choice Massage', price: '$175' },
      { name: 'First Massage Offer', price: '$85' },
...
export const packagesData = [
  {
    name: '4 Sessions of SkinPen',
    price: '$1400',
    description: 'Choose PRP or VAMP add-on for $200/session'
  },
  {
    name: 'Summer Glow SPF Deal',
    price: '10% Off',
    description: 'All SPF products from Skinbetter or ColorScience'
  },
  {
    name: 'Massage Bundle (3x 60-min)',
    price: '$299',
    description: 'Includes 3 standard massages + free add-on'
  }
]
