...
const s = getDefaultService('daxxify'); // slug: 'jeuveau', name preset
...
s.quickFacts = s.quickFacts?.length ? s.quickFacts : [
  ...
  { iconKey: 'fire', label: 'Duration', value: 'Typically 6-weeks longer than other tox' },
...
s.appointmentSteps = [
  'Cleanse + map.',
  'Knjections (10–20 min).',
  'No downtime; avoid workouts 24 hrs.',
  'Results in ~2 days; peak by 14.',
];
// Overview: keep to 1–2 short paragraphs
s.overview = {
  p1: 'Daxxify® is a next-gen wrinkle relaxer that softens frown lines and other expression lines with tiny, precise injections. Its peptide-enhanced formula helps it settle smoothly for natural, not “frozen,” results—most people notice a refreshed look within a few days, with no downtime.',
  p2: 'During your visit, we map your unique expressions and tailor dosing to your goals and schedule. Many clients like Daxxify because results can last longer than traditional options for some people; we’ll talk through what that could mean for you, side effects to expect (usually mild redness or bumps for a few minutes), and an easy plan for maintenance.'
};

s.seo = {
  title: 'DAXXIFY® in Westfield & Carmel, IN | RELUXE Med Spa',
  description:
    'DAXXIFY® (peptide-powered, longer-lasting tox) for smooth, natural results by NP/RN injectors. Book in Westfield or Carmel. Honest dosing, follow-ups & member value.',
...
s.pricing = {
  single: '$7/unit',
  packages: [{ label: 'Member Unit Price', value: '$5/unit' }],
};
...
s.faq = [
  { q: 'What is Daxxify?', a: 'Daxxify is an FDA-approved neurotoxin designed to smooth dynamic wrinkles (caused by muscle movement) such as frown lines, forehead lines, and crow’s feet.' },
  { q: 'Why are Dysport units so much cheaper than Botox?', a: 'Daxxify units are cheaper because they’re measured differently — it takes about 2 units of Dysport to equal 1 unit of Botox. The cost per treatment area ends up being similar.'},
  { q: 'How is Daxxify different from Botox or Jeuveau?', a: 'Daxxify works the same way but is formulated to last longer — in some patients, results last 6 weeks longer compared to the typical 3–4 months for Botox or Jeuveau.'},
  { q: 'Which should I choose: Daxxify or Jeuveau or Botox?', a: 'We love all! If you prefer fewer appointments and potentially longer-lasting results, Daxxify may be your choice. Botox and Jeuveau are great if you like the flexibility to adjust your look more often.'}, 
  ...
  { q: 'Can I pair Daxxify with other treatments?', a: 'Absolutely — it pairs beautifully with dermal fillers, facials, and laser treatments for a more complete rejuvenation. Order is important, so our team can help ensure you get the best result!' },
  { q: 'Is Daxxify a filler?', a: 'No — Filler that adds volume under the skin, while Daxxify is a neurotoxin that reduces muscle movement to smooth wrinkles. They treat different concerns.' },
];
s.flexEverything = {
