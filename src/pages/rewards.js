...
export default function BetaRewards() {
  ...
  return (
    <BetaLayout title="RELUXE Rewards Program" description="Earn rewards on every Botox, filler, facial & laser treatment at RELUXE Med Spa. $1 back for every $100 spent, applied automatically. Westfield & Carmel, IN." canonical="https://reluxemedspa.com/rewards">
      {({ fontKey, fonts }) => (
        <>
          {/* Hero */}
