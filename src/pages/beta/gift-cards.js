...
export default function BetaGiftCards() {
  ...
  return (
    <BetaLayout title="Gift Cards | RELUXE Med Spa" description="Give the gift of luxury treatments. RELUXE gift cards are valid for 5 years at both Indiana locations. Choose any amount from $25 to $2,000.">
      {({ fontKey, fonts }) => (
        <>
          {/* ─── Hero ─── */}
