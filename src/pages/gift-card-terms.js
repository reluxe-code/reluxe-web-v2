...
export default function GiftCardTermsPage() {
  ...
  return (
    <BetaLayout
      ...
      description="Gift card redemption, expiration, and lost/stolen card policies."
      canonical="https://www.reluxemedspa.com/gift-card-terms"
    >
      {/* Hero */}
      <header
        style={{
...
GiftCardTermsPage.getLayout = (page) => page
