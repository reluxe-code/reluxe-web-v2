 ...
 *  ========================= */
const OFFER_NAME = 'New Patient Jeuveau Intro'
const OFFER_PRICE = '$380'
const OFFER_VALUE = '$600 value'
const OFFER_BASELINE = '50 units'
const OFFER_ADDON = '$6/unit'
const OFFER_NOTE = 'Most patients fall ±10 units.'
...
// Swap these to Jeuveau-specific results when ready
const JEUVEAU_RESULTS = [
...
const JEUVEAU_TESTIMONIALS = [
  { author: 'Jennifer S.', location: 'Westfield, IN', service: 'Jeuveau', rating: 5, text: 'The whole visit was so easy—and I loved my results!', monthYear: 'Feb 2025' },
  { author: 'Marcus L.', location: 'Carmel, IN', service: 'Jeuveau (Forehead + 11s)', rating: 5, text: 'Natural look, no heaviness. Booking again before my next event.', monthYear: 'Jan 2025' },
  { author: 'Priya A.', service: 'Jeuveau', rating: 5, text: 'Quick appointment and super friendly team. Subtle but noticeable improvement.', monthYear: 'Dec 2024' },
]
