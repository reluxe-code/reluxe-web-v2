...
export default function NewPatientDaxxifyPage() {
  ...
  return (
    <BetaLayout
      ...
      canonical="https://reluxemedspa.com/landing/new-patient-daxxify"
    >
      {/* Hero */}
      <section
        style={{
          ...
          <div style={{ color: colors.white, maxWidth: '64rem' }}>
            ...
            <div style={{ marginTop: '1.25rem', display: 'inline-flex', flexWrap: 'wrap', alignItems: 'center', gap: '0.5rem', borderRadius: '9999px', backgroundColor: 'rgba(250,248,245,0.05)', padding: '0.75rem 1rem', border: '1px solid rgba(250,248,245,0.1)' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <span style={{ fontFamily: fonts.body, fontSize: '0.875rem', color: colors.white }}>220+ Google Reviews</span>
              </div>
...
NewPatientDaxxifyPage.getLayout = (page) => page
