...
import NLSearchExplorer from '@/components/experiments/NLSearchExplorer';
...
export default function NLSearchExperiment({ testimonials, staff }) {
  ...
  return (
    <BetaLayout
      title="AI Appointment Search"
      description="Describe your ideal appointment in plain English and we'll find the perfect match. Voice search, smart recommendations, instant results."
      noindex
    >
      {({ fontKey, fonts }) => (
        <>
          ...
          {/* ─── NL Search Explorer ─── */}
          <NLSearchExplorer fonts={fonts} fontKey={fontKey} staff={staff} />
...
NLSearchExperiment.getLayout = (page) => page;
