          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {staff.slice(0, 8).map((s) => {
                ...
                return (
                  <a key={s.slug} href={`/team/${s.slug}`} className="flex items-center gap-2 rounded-full px-3 py-1.5 transition-all duration-200 hover:shadow-md" style={{ backgroundColor: colors.cream, border: `1px solid ${colors.stone}`, textDecoration: 'none' }}>
...
export default function BetaLocationsIndex({ locationData, staffByLocation, testimonials }) {
    ...
    '@graph': [
      {
        ...
        areaServed: ['Westfield IN', 'Noblesville IN', 'Carmel IN', 'Zionsville IN'],
      },
      {
        '@type': 'MedicalBusiness',
  ...
  return (
    <BetaLayout
      title="Med Spa Locations — Westfield & Carmel, Indiana"
      description="Visit RELUXE Med Spa in Westfield or Carmel, Indiana. Botox, facials, Morpheus8 & 40+ treatments. Two luxury locations, free parking, same-day appointments. Hours, directions & online booking."
      canonical="https://reluxemedspa.com/locations"
