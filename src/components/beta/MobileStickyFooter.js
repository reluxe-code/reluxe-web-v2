...
export default function MobileStickyFooter({ fontKey = 'bold' }) {
  ...
  const show = !bookingModalOpen && !drawerOpen && !rebookOpen;
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Chat button — inline in footer bar, dispatches event to ChatWidget */}
          <button
              onClick={() => window.dispatchEvent(new Event('reluxe:toggle-chat'))}
