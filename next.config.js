  ...
  async headers() {
    ...
    const globalSecurityHeaders = [
      ...
      { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
      {
        ...
        value: [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://connect.facebook.net https://www.googletagmanager.com https://www.google-analytics.com https://snap.licdn.com https://cdn.vercel-insights.com https://www.instagram.com https://www.tiktok.com https://*.joinboulevard.com https://*.joinblvd.com https://*.boulevard.io https://*.blvd.app",
